...
\institute[shortinst]{
  \Large University of Bristol, Dept. of Engineering}
...
\abovefooter{
  \hfill\includegraphics[height=6ex]{../common/graphics/uob-logo-transparent.png}
  \hspace*{1ex}\includegraphics[height=10ex]{../common/graphics/demonstration-link.png}
}
