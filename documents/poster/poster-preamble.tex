...
\abovefooter{
  \hfill\includegraphics[height=10ex]{../common/graphics/uob-logo-transparent.png}
  \hspace*{1ex}\includegraphics[height=9ex]{../common/graphics/demonstration-link.png}
}
